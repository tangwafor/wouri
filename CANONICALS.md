...
**ADR-0027. The four sprint gates and the one hard rule.** Every sprint ends on build, e2e sweep, machine self-test, and a Fabrice UAT run. Do not generate the component specs or start Sprint 1 until one real consignment file has been seen.
